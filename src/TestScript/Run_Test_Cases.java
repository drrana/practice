...
public class Run_Test_Cases {
	...
	**/
	...
	@Test (priority = 1)
	public void Verify_LoggedIn_User_with_Invalid_Username() throws Exception
  	{
  		try
  		{
  			BusinessUnit.Verify_LoggedIn_User_with_Invalid_Username(ObjectRepository.scenario2);
	 ...
	 @AfterMethod
	    ...
	    public void tearDown() throws Exception {
	 	...
	 	{
	 		Genericmethod.SendmailWithAttachment(ObjectRepository.Controller_sheet_email_details);
	 	}
